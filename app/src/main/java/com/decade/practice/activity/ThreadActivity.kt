...
import com.decade.practice.composable.ChatInfoBar
import com.decade.practice.composable.ConversationList
import com.decade.practice.composable.InputBar
import com.decade.practice.composable.LocalConversation
import com.decade.practice.composable.LocalUser
import com.decade.practice.composable.MessageList
import com.decade.practice.composable.OnlineList
import com.decade.practice.composable.SearchField
import com.decade.practice.composable.Setting
...
import com.decade.practice.viewmodel.MessageViewModel
import com.decade.practice.viewmodel.MessageViewModelFactory
import com.decade.practice.viewmodel.OnlineViewModel
import com.decade.practice.viewmodel.OnlineViewModelFactory
import com.decade.practice.viewmodel.ThreadViewModel
import com.decade.practice.viewmodel.ThreadViewModelFactory
...
fun ThreadScreen(navController: NavController) = Column(
      ...
      val viewModel: ThreadViewModel = hiltViewModel(
            creationCallback = { factory: ThreadViewModelFactory ->
                  factory.create(session.dialogRepository)
            }
      )
...
fun OnlineScreen(navController: NavController) {
      ...
      val viewModel: OnlineViewModel = hiltViewModel(
            creationCallback = { factory: OnlineViewModelFactory ->
                  factory.create(
                        session.account,
                        session.onlineRepository,
                        session.dialogRepository
                  )
            }
      )
      viewModel.refresh()
      ...
      val onlineList by viewModel.dialogFlow.collectAsStateWithLifecycle()
      OnlineList(navController = navController, dialogList = onlineList)
